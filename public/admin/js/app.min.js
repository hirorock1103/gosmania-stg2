    ...
    $.AdminLTE.layout = {
            ...
            fix: function() {
                var a = $(".main-header").outerHeight() + $(".main-footer").outerHeight(),
                    b = $(window).height(),
                    c = $(".sidebar").height();
                $("body").hasClass("fixed") ? $(".right-side").css("min-height", b - $(".main-footer").outerHeight()) : b >= c ? $(".right-side").css("min-height", b - a) : $(".right-side").css("min-height", c)
            },
            fixSidebar: function() {
        ...
        $.AdminLTE.tree = function(a) {
            ...
            if ($.cookie("menu-state") == "open") {
                var c = $("li.treeview").eq($.cookie("menu-index")),
                    d = c.children("a").next();
                var e = c.parents("ul").first(),
                    f = e.find("ul:visible").slideUp("normal");
                f.removeClass("menu-open");
                var childIndex = $('li.treeview ul li').eq($.cookie('menu-index-child'));
                var g = c.parent("li");
            ...
            $(".logo").click(function() {
                ...
                $.cookie("menu-index-child", 0, {
                    path: "/"
                });
            })
            $(".sidebar-menu li.treeview").click(function() {
                var index = $(".sidebar-menu li.treeview").index(this);
                $.cookie("menu-index", index, {
                    path: "/"
                });
            })
            $(".sidebar-menu li.treeview ul li").click(function() {
                var childIndex = $(".sidebar-menu li.treeview ul li").index(this);
                $.cookie("menu-index-child", childIndex, {
                    path: "/"
                });
            })
            ...
            $("li a", $(a)).click(function(a) {
                ...
                if (d.is(".treeview-menu") && d.is(":visible")) {
                    ...
                    d.slideDown("normal", function() {
                        d.addClass("menu-open"),
                        e.find("li.treeview.active").removeClass("active"),
                        g.addClass("active"),
                        b.layout.fix()
                    });
                    $.removeCookie("menu-index");
                    $.cookie("menu-state", "open", {
                        path: "/"
                    });
                }
