						...
						<div class="col-xs-12">
							...
							<div class="">
								<div class="search_results">
									...
									<h3 class="text-danger">開発用本文プレビュー(1件目の中身)</h3>
									<span style="white-space: pre-wrap; word-break: break-all;"><?php echo generateMailContent(getSendMailData($dbh, 0), $list[array_key_first($list)]); ?></span>
								</div>
							</div>
						</div><!-- col-xs-12 -->
					</div><!-- row -->
