						...
						<tbody>
							...
							<tr>
								...
								<td class="radioArea">
									...
									<p class="float_box" style="margin-top: 0; margin-bottom: 0;">GOSMANIA会員有効期限・クレジットカード有効期限が近くなりましたら、ご案内メールをお送りいたします。<br>
										※配信を希望されない場合でも、重要なお知らせについて配信する場合がございます。
									</p>
							...
							<tr>
								<th>連絡がつく電話番号(ハイフンあり)<span>必須</span></th>
								<td>
									<input
										type="text"
