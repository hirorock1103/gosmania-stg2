			...
			<!--<img src="./image/gos_logo2.png" style="width: 120px; margin-left:130px;"> -->
				<div class="block-gosmania2">
					<?php if($status === 'credit_update') { // クレジット情報更新 credit_edit.php ?>
						...
						<p class="txt-credit" style="margin-top:40px;">※会員有効期限の1ヶ月半前までに登録・更新されていない場合は、<br>翌年度以降のクレジットカード決済となります。<br><br>ご不明な点などございましたら、GOSMANIAまでお問い合わせくださいますようお願いいたします。</p>
					...
					<?php } else if($status === 'cs_info_update') { // 顧客情報更新 customer_info_edit.php ?>
						...
						<p class="txt-credit" style="margin-top:40px;">※メールの配信・停止反映までに最大で1ヶ月お時間を頂戴する場合がございます。<br><br>
