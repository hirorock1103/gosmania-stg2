...
//GMO設定ファイル
// GMO定義 --------------------------------------------------
define("GMO_API_TOKEN_AUTH_JS", "https://stg.static.mul-pay.jp/ext/js/token.js");//

define("GMO_API_SITE_ID", "tsite00044188"); //テスト環境
define("GMO_API_SITE_PASS", "yhpkut28"); //　テスト環境
define("GMO_API_TOKEN_AUTH_SHOP_ID", "tshop00051136"); //テスト環境
