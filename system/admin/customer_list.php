...
if( isset($_POST) && !empty($_POST) ) {
	...
	//query
	$query = "select  SQL_CALC_FOUND_ROWS *,C.Cs_Id as Cs_Id from Customer as C LEFT JOIN (select * from CustomerInfo where Ci_Seq in (select max(Ci_Seq) from CustomerInfo group by Cs_Id)) as CI ON C.Cs_Id = CI.Cs_Id order by Cs_Id ASC  limit 100";
