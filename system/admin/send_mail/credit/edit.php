			...
			<section class="content">
				<?php if(!empty($err) && $data['submit'] != '確認' && $data['submit'] != '更新' ) { ?>
					<div class="alert alert-danger ">
						...
						<form action="/admin/send_mail/credit/detail.php" name="back_detail" method="POST" id="back_detail">
				...
				<?php } else { ?>
					...
					<form action="/admin/send_mail/credit/detail.php" name="back_detail" method="POST" id="back_detail"></form>
				<?php } ?>
			</section><!-- /.content -->
		</div><!-- /.content-wrapper -->
	</div><!-- ./wrapper -->
	<?php include '../../script.php';?>
	<pre><?php var_dump($_POST, $table_ary['html']);?></pre>
</body>
</html>
